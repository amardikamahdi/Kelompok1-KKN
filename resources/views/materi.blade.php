...
<div class="container mx-auto mt-8">
    <h1 class="text-5xl uppercase mb-8 text-center font-medium underline underline-offset-8">Kelas IV</h1>
    ...
    <h1 class="text-5xl uppercase mt-8 mb-8 text-center font-medium underline underline-offset-8">Kelas V</h1>
    <div class="h-56 grid grid-cols-3 gap-4 content-start">
        <div>
            <a href="#"
                class="block p-6 max-w-sm bg-white rounded-lg border border-gray-200 shadow-md hover:bg-gray-100 dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700">
    ...
    <h1 class="text-5xl uppercase mt-8 mb-8 text-center font-medium underline underline-offset-8">Kelas VI</h1>
    <div class="h-56 grid grid-cols-3 gap-4 content-start">
        <div>
            <a href="#"
                class="block p-6 max-w-sm bg-white rounded-lg border border-gray-200 shadow-md hover:bg-gray-100 dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700">
